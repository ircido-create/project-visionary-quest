 ...
 * explicar depois por que duas afiliadas receberam leituras diferentes.
 *
 ...
 * contribuem para a leitura e, combinados com o nicho, podiam identificar a afiliada
...
export const analysisSchema = z.object({
  resumo: z.string().describe("Duas ou três frases sobre onde a afiliada está hoje."),
...
de afiliadas a criadora de conteúdo no Instagram.

O método tem cinco etapas: Estruture (nicho, bio, organização do perfil),
Apareça, Conecte, Ensine e Converta. Sua leitura deve situar a afiliada nessas etapas.
...
2. Você não decide se a afiliada é aprovada. A qualificação é feita por regras
   determinísticas fora daqui, e a decisão final é de uma pessoa.
3. Nunca afirme nem sugira que a afiliada será aprovada em qualquer programa.
...
5. Em "proximos_passos", proponha ações que a afiliada consiga executar sozinha nas
